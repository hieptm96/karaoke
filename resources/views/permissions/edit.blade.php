...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title">Cập nhật thông tin quyền truy cập</h4>
            <ol class="breadcrumb">
                <li>
                    <a href="/">Hệ thống</a>
                </li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Thông tin</b></h4>

                <form class="form-horizontal" method="post" action="{{ route('permissions.update', $permission->id) }}" role="form"  data-parsley-validate novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="name" value="{{ $permission->name }}" class="form-control" id="input-name" placeholder="" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="display_name" value="{{ $permission->display_name }}" class="form-control" id="input-name" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="description" value="{{ $permission->description }}" class="form-control" id="input-name" placeholder="">
                        </div>
                    </div>
