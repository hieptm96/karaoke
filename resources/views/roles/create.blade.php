...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title">Thêm mới roles</h4>
            <ol class="breadcrumb">
                <li>
                    <a href="/">Hệ thống</a>
                </li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Thêm mới roles</b></h4>

                <form class="form-horizontal" method="post" action="{{ route('roles.store') }}" role="form"  data-parsley-validate novalidate>
                    <input type="hidden" value="{{ csrf_token() }}" name="_token">

                    <div class="form-group">
                        <label for="input-name" class="col-sm-2 control-label">Tên <span class="text-danger">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" name="name" value="" class="form-control" id="input-name" placeholder="" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="display_name" value="" class="form-control" id="input-name" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="description" value="" class="form-control" id="input-name" placeholder="">
                        </div>
                    </div>
